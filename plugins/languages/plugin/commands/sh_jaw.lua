...
local COMMAND = Clockwork.command:New("Jaw");
COMMAND.tip = "Speak in Jawaese.";
...
function COMMAND:OnRun(player, arguments)
	...
	Clockwork.chatBox:SendColored(v, Color(212, 214, 122, 255), "[Jawaese] "..player:Name().." says: "..speech)
			else
		...
		Clockwork.player:Notify(player, "You do not speak Jawaese!")
	end;
end;
